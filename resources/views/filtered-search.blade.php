...
@section('content')
    ...
    <div class="bg-gray-100 flex flex-col rounded dark:bg-gray-800">
        ...
        <form method="get" action="{{ route('search') }}" class="p-2">
            <div class="grid lg:grid-cols-5 md:grid-cols-2 sm:grid-cols-1 gap-2">
                <input type="text" name="keyword" placeholder="Keyword..."  class="mx-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-300 focus:border-gray-300 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <button type="submit" class="bg-blue-600 p-2 rounded-lg hover:bg-blue-700 text-white font-semibol">
    ...
    @if (count($recipes) > 0)
        <div id="card"
        class="bg-gray-100 grid justify-center xl:grid-cols-6 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1 my-2 py-2 rounded md:flex-row
        dark:bg-gray-800 ">
