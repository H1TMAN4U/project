            ...
            <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg">
                <div class=" text-gray-900 dark:text-gray-100">
                    ...
                    <div class="w-full p-2 break-all bg-white rounded flex lg:flex-row md:flex-row sm:flex-col-reverse dark:bg-gray-900" style="">
                        <div class="px-2 text-black flex flex-col lg:items-start md:items-start sm:text-center sm:mt-[30px] justify-center dark:text-white">
                            <h1 class="lg:text-[54px] md:text-[32px] sm:text-[32px] break-normal" style="font-family: 'Playfair Display', serif;">Lets start cooking with popular recipes</h1>
                            <p class="mt-4 text-gray-600 break-normal font-bold lg:text-[22px] md:text-[18px] sm:text-[18px]">Want to learn how to cook but confused how to start? <br> No need to worry again!</p>
