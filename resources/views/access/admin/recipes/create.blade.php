    ...
    <form method="post" action="{{ route('recipes.store') }}" enctype="multipart/form-data">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                ...
                <input type="text" id="name" name="name" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-300 focus:border-gray-400 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Recipe name" required>
            </div>

            {{-- Category select --}}
            <div>
                <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an option</label>
                <select id="category" name="category_id" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-300 focus:border-gray-400 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class="mb-6">
            <div class=" bg-gray-300 w-full mb-4 border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class=" bg-gray-200 px-4 py-2 rounded-b-lg dark:bg-gray-800">
                    ...
                    <textarea id="descriptions" name="descriptions" id="descriptions" rows="8" class="bg-gray-200 block w-full px-0 text-sm text-gray-800 border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Descriptions..." required></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6">
            <div class="bg-gray-300 w-full mb-4 border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="bg-gray-200 px-4 py-2 rounded-b-lg dark:bg-gray-800">
                    ...
                    <textarea name="instructions" id="instructions" rows="8" class="bg-gray-200 block w-full px-0 text-sm text-gray-800 border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Instructions..." required></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6">
            <div class="flex items-center justify-center w-full">
                <label for="dropzone-file" class="bg-gray-50 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
