                                    ...
                                    <div id="instruction-{{ $instruction->id }}" class="instruction-step">
                                        ...
                                        <div class="relative my-2">
                                            ...
                                            <button data-instruction-id="{{ $instruction->id }}"
                                                ...
                                                <svg class="bg-white rounded-full w-5 h-5 mx-2 {{ $instruction->step_number == 1 ? 'text-gray-400' : 'text-red-500' }} flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        $(document).on('click', '.delete-instruction-btn', function() {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(data) {
                                                    $('#instruction-' + instructionId).remove(); // Remove the deleted instruction from the DOM
                                                },
                                                error: function(data) {
                                                    console.log(data);
                                                }
                        ...
                        <div class="grid md:grid-cols-1 gap-2 text-white font-semibold" id='values'>
                            ...
                            <div id="container-for-{{ $ingredient->id }}" class="flex flex-row">
                                ...
                                <div class="relative flex flex-row">
                                    ...
                                    <button type="button" data-container-id="{{ $ingredient->id }}"
                                        data-checkbox-id="{{ $ingredient->id }}" data-ingredients-id="{{ $ingredient->id }}" data-recipes-id="{{ $value->id }}"
                                        class="delete-btn absolute inset-y-0 right-0 flex items-center px-1 text-red-500 border border-l-0 border-transparent">
                                        <svg class="w-4 h-4 ml-2 mr-1.5 text-red-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"></path>
                                        </svg>
                                    </button>
                                </div>
