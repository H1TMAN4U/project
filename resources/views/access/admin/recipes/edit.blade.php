...
<div class="max-w-7xl mx-auto mt-8 pb-8 break-all" style="width: 100%; height:100vh;">
    <form method="post" action="{{ route('update-recipe',$recipes->id) }}">
        @method('PUT')
        @csrf
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Recipe name</label>
                <input type="text" id="name" name="name" value="{{ $recipes->name }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Recipe name" required>
            </div>
        ...
        <div class="mb-6">
            <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                    ...
                    <textarea id="descriptions" name="descriptions" id="descriptions" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Descriptions..." required>{{ $recipes->descriptions }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6">
            <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                    ...
                    <textarea name="instructions" id="instructions" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Instructions..." required>{{ $recipes->instructions }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <input value="{{ $recipes->img }}" name="img" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file">
            <input type="hidden" name="hidden_img" value="{{ $recipes->img }}" />
        </div>
                        ...
                        <li>
                            <div class="grid items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                @foreach ($ingredients as $value)
                                    <div>
                                        <input id="checkbox-item-11" type="checkbox"  name="ingredients[]" value="{{$value->name}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="checkbox-item-11" class="w-full ml-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">{{$value->name}}</label>
                                    </div>
                                @endforeach
                            </div>
                        </li>
                ...
                <div
                    ...
                    <div class=" bg-gray-100 px-4 py-2 rounded-b-lg dark:bg-gray-800">
                        ...
                        <textarea id="descriptions" name="descriptions" id="descriptions" rows="8"
                            ...
                            placeholder="Descriptions..." required>{{$recipes->descriptions}}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div
                    ...
                    <div class="bg-gray-100 px-4 py-2 rounded-b-lg dark:bg-gray-800">
                        ...
                        <textarea name="instructions" id="instructions" rows="8"
                            class="bg-gray-100 block w-full px-0 text-sm text-gray-800 border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
                            placeholder="Instructions..." required>{{$recipes->instructions}}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6">
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file"
                        ...
                        <input id="dropzone-file" name="img" type="file" class="hidden" />{{$recipes->img}}
                        <input type="hidden" name="hidden_img" value="{{ $recipes->img }}" />
