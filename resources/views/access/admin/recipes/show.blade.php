...
<div class="flex flex-col items-center my-1 bg-white border border-gray-200 rounded shadow md:flex-row md:max-w-7xl dark:border-gray-700 dark:bg-gray-800">
    <img class="m-4 w-full rounded h-full md:h-[500px] md:w-[500px] md:rounded-none md:rounded" src="{{ asset('images/' . $recipe->img) }}" alt="">
    <div class="flex flex-col p-4 leading-normal items-center">
        ...
        <div class="flex flex-row items-center text-yellow-300 p-2">
            ...
            <div class="relative flex items-center justify-center">
                ...
                <h1 class="absolute text-white font-black text-xl mt-1">{{ $averageRating }}</h1>
            </div>
        </div>
        ...
        <button type="button" data-users-id="{{ Auth::user()->id }}" data-recipes-id="{{ $recipe->id }}"
            class="create-bookmark text-white w-1/2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 my-5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            Bookmark
        </button>
    </div>
</div>

<div class="block md:max-w-7xl my-1 p-6 bg-white border border-gray-200 rounded shadow dark:bg-gray-800 dark:border-gray-700">
    <div class="my-5">
        ...
        @if (count($ingredients) > 0)
            ...
            @endforeach
        @else
            <h1 class="bg-gray-100 my-2 py-2 font-semibold rounded text-center dark:bg-gray-800">No Data Found</h1>
        @endif
    </div>
    <div class="my-5">
...
<section class="py-8">
    <div class="bg-gray-100 flex flex-col rounded dark:bg-gray-800">
        ...
        <div class=" py-8 px-2 border-t border-gray-600">
            <form id="rating-form" class="flex flex-col items-center" method="POST">
                @csrf
                ...
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold p-2 rounded-lg mt-2 w-1/2">
                    Post
                </button>
            </form>
