...
<div class="bg-gray-100 flex flex-col rounded dark:bg-gray-800">
    <h1 class="border-b font-bold border-gray-600 mb-1 p-2">All Recipes</h1>
    ...
    @if (count($recipes) > 0)
        {{-- @if (Auth::user()->can('Publish'))
            <div
                class="bg-gray-300 grid justify-center md:grid-cols-5 grid-cols-3 my-2 py-4 px-4 rounded md:flex-row
                dark:bg-gray-800 ">
