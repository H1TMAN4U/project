    ...
    <div class="bg-gray-200 flex flex-col rounded
        ...
        <div class="border-b border-gray-600 mb-1">
            <div
                ...
                dark:text-gray-200">
                <h1><b>Bookmarks</b></h1>
                <button onclick="myFunction()" class=" bg-red-600 text-white rounded px-4 hover:bg-red-700">Delete</button>
            </div>
        </div>
        ...
        dark:bg-gray-800 ">
            ...
            @foreach ($recipes as $value)
                <div
                    ...
                    <form method="post" class="" action="{{ route('user.destroy', $value->id) }}">
                        @csrf
                        @method('DELETE')
                        <button class="delete hidden bg-red-600 text-white rounded px-4 hover:bg-red-700 float-right"
                            type="submit" value="{{ $value->id }}">Delete</button>
                    </form>
                    <a href="#">
                    ...
                    <div class="p-5">
                        ...
                        <i onclick="changeIcon(this)" class="fa-regular fa-bookmark fa-2xl" style="color: #700ada;"></i>
                    </div>
