    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-white justify-between flex-col flex dark:bg-gray-800 ">
        <ul class="space-y-2 font-medium">
            <div class="flex flex-row justify-center items-center flex-shrink-0 px-4 py-4">
                <a href="#" class="text-md font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark:text-white focus:outline-none focus:shadow-outline">
                    Flavor Fusion
                </a>
            ...
            <div class="text-center ">
                <form class="flex items-center py-1" type="get" action="{{ route('search-recipes') }}">
                    <div class="relative w-full">
                        ...
                        <x-text-input name="search" type="text" id="search-recipes"
           ...
           <li>
                 <button aria-controls="recipes-dropdown" data-collapse-toggle="recipes-dropdown" type="button"
                 class="flex flex-row items-center w-full px-4 py-2 mb-2 text-sm font-semibold text-gray-900 bg-transparent rounded hover:text-gray-900 focus:text-gray-900 hover:bg-gray-100 focus:bg-gray-200 focus:outline-none focus:shadow-outline transition duration-500 ease-in-out
                dark:hover:bg-gray-700 dark:focus:bg-gray-700 dark:focus:text-white dark:hover:text-white dark:text-gray-200 ">
                ...
                <ul id="recipes-dropdown" class="bg-white shadow p-2 hidden py-2 space-y-2 rounded dark:bg-gray-700">
                    ...
                    <li>
                        <x-responsive-nav-link :href="route('lunch')" :active="request()->routeIs('lunch')">
                            <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd"></path></svg>
                            <span class="ml-3">Lunch</span>
                        </x-responsive-nav-link>
                    </li>
                    <li>
                        <x-responsive-nav-link :href="route('snacks')" :active="request()->routeIs('snacks')">
                            <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd"></path></svg>
                            <span class="ml-3">Snacks</span>
                        </x-responsive-nav-link>
                    </li>
                    <li>
                        <x-responsive-nav-link :href="route('dinner')" :active="request()->routeIs('dinner')">
                            <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd"></path></svg>
                            <span class="ml-3">Dinner</span>
                        </x-responsive-nav-link>
                    </li>
                    <li>
                        <x-responsive-nav-link :href="route('dessert')" :active="request()->routeIs('dessert')">
                            <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd"></path></svg>
                            <span class="ml-3">Dessert</span>
                        </x-responsive-nav-link>
                    </li>
                    <li>
                        <x-responsive-nav-link :href="route('drinks')" :active="request()->routeIs('drinks')">
                            <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd"></path></svg>
            ...
            <li>
                 <button aria-controls="controls-dropdown" data-collapse-toggle="controls-dropdown" type="button"
                  class="flex flex-row items-center w-full px-4 py-2 mb-2 text-sm font-semibold text-gray-900 bg-transparent rounded hover:text-gray-900 focus:text-gray-900 hover:bg-gray-100 focus:bg-gray-200 focus:outline-none focus:shadow-outline transition duration-500 ease-in-out
                  dark:hover:bg-gray-700 dark:focus:bg-gray-700 dark:focus:text-white dark:hover:text-white dark:text-gray-200 ">
                  <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-500 ease-in-out dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                 ...
                 <ul id="controls-dropdown" class="bg-white shadow p-2 hidden py-2 space-y-2 rounded dark:bg-gray-700">
                    ...
                    <li>
                     ...
                     {{-- @endif --}}
                    <li>
                        <x-responsive-nav-link :href="route('admin.control.recipe')" :active="request()->routeIs('admin.control.recipe')">
                            <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd"></path></svg>
                            <span class="ml-3">Recipes</span>
                        </x-responsive-nav-link>
                    </li>
                 </ul>
             @endif
            ...
            <ul class="w-full flex flex-col items-start text-gray-500 bg-white p-2 dark:bg-gray-800">
                @auth
                    ...
                    <li class="w-full">
                        ...
                        <x-admin-link onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="flex items-center cursor-pointer">
                            <svg aria-hidden="true" class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
